...
class _TeachersPageState extends State<TeachersPage> {
  ...
  final String _cacheKey = 'counselor_manage_teacher_data';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (mounted && _teachers.isEmpty) {
          setState(() {
            _errorMessage = ApiService.errorMessage(response, "Failed to load teachers");
            _isLoading = false;
          });
        }
      }
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: LoadingWrapper(
          ...
          hasData: _teachers.isNotEmpty,
          skeleton: _buildSkeleton(),
          child: _errorMessage != null && _teachers.isEmpty
              ? Center(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        FilledButton.icon(onPressed: _fetchTeachers, icon: const Icon(Icons.refresh), label: const Text("RETRY")),
                      ],
                    ),
                  ),
                )
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return Card(
                                      ...
                                      child: ListTile(
                                        ...
                                        trailing: _statusBadge(context, teacher.status ?? "Active"),
                                      ),
                                    );
                                  },
                                ),
