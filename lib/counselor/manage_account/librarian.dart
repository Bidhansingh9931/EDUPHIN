...
class _LibrarianPageState extends State<LibrarianPage> {
  ...
  final String _cacheKey = 'counselor_manage_librarian_data';
  ...
  Future<void> _fetchLibrarians() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (mounted && _librarians.isEmpty) {
          setState(() {
            _errorMessage = ApiService.errorMessage(response, "Failed to load librarians");
            _isLoading = false;
          });
        }
      }
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: LoadingWrapper(
          ...
          child: _errorMessage != null && _librarians.isEmpty
              ? Center(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        FilledButton.icon(onPressed: _fetchLibrarians, icon: const Icon(Icons.refresh), label: const Text("RETRY")),
                      ],
                    ),
                  ),
                )
