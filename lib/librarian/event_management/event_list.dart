...
class _ExploreEventsPageState extends State<ExploreEventsPage> {
  ...
  late Stream<List<model.Event>> _eventsStream;
  ...
  void _updateStream() {
    ...
    setState(() {
      _eventsStream = ApiService.getLibrarianEventsStream(status: status, type: type).asBroadcastStream();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<model.Event>>(
        stream: _eventsStream,
        builder: (context, snapshot) {
          return LoadingWrapper<List<model.Event>>(
            snapshot: snapshot,
