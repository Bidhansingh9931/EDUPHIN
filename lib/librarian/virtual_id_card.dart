          ...
          Column(
            children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(data.instituteAddress ?? "LIBRARIAN IDENTIFICATION", style: TextStyle(color: colorScheme.onPrimary.withValues(alpha: 0.7), fontSize: context.font(9), fontWeight: FontWeight.bold, letterSpacing: 0.5), overflow: TextOverflow.ellipsis, maxLines: 1),
                        ],
                      ),
                    ),
                  ],
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _buildRowInfo(context, "EMPLOYEE ID", "LIB-${user.id.toString().padLeft(4, '0')}", "GENDER", detail.gender ?? "N/A"),
                    Padding(
                    ...
                    _buildRowInfo(context, "DOB", detail.dateOfBirth ?? "N/A", "PHONE", detail.phone ?? "N/A"),
                  ],
                ),
              ),
