...
class _AddCounselorPageState extends State<AddCounselorPage> {
  ...
  Widget _buildDropdownField(BuildContext context, String title, String? value, List<String> items, ValueChanged<String?> onChanged) {
    final theme = Theme.of(context);
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 8.0),
